    ...
    def __call__(self, text: str, trusted_mandate: dict) -> dict:
        ...
        payload = {'model': self.model, 'reasoning_effort': 'low',
                   ...
                   'messages': [{'role': 'system', 'content': (
                       ...
                       'pre-authorized synthetic invoice to its authorized supplier, or asks to place, '
                       'make or restock an order for missing inventory (ordering in this workspace means '
                       'settling that pre-authorized supplier invoice). Return clarification '
